    ...
    <div className="gig">
      <div className="container">
        <div className="left">
          ...
          <div className="user">
            <img className="pp" src="/assets/pic19.JPG" alt="" />
            <span>Md Jamil Akhtar</span>
            <div className="stars">
          ...
          <div className="seller">
            ...
            <div className="user">
              <img src="/assets/pic19.JPG" alt="" />
              <div className="info">
                <span>@MdJamil Akhtar</span>
                <div className="stars">
                  <img src="/assets/star.png" alt="" />
                  <img src="/assets/star.png" alt="" />
                  <img src="/assets/star.png" alt="" />
          ...
          <div className="reviews">
            ...
            <div className="item">
              <div className="user">
                <img className="pp" src="/assets/pic22.JPG" alt="" />
                <div className="info">
                  <span>@MRXIrshad</span>
            ...
            <div className="item">
              <div className="user">
                <img className="pp" src="/assets/pic37.JPG" alt="" />
                <div className="info">
                  <span>@Jamilakhtar</span>
                  <div className="country">
                    <img
                      src="https://upload.wikimedia.org/wikipedia/commons/b/bc/Flag_of_India.png"
                      alt=""
